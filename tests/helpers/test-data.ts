...
export const TEST_COMBINATIONS = {
  scripture: [
    ...
    { reference: TEST_DATA.references.singleVerse, language: TEST_DATA.languages.english },
    { reference: TEST_DATA.references.singleVerse, language: TEST_DATA.languages.spanish },
    { reference: TEST_DATA.references.singleVerse, language: TEST_DATA.languages.spanishVariant },
    { reference: TEST_DATA.references.verseRange },
    { reference: TEST_DATA.references.singleVerse, organization: TEST_DATA.organizations.unfoldingWord },
  ],
  ...
  translationWords: [
    ...
    { path: TEST_DATA.translationWords.faith.path, language: TEST_DATA.languages.english },
    { path: TEST_DATA.translationWords.faith.path, language: TEST_DATA.languages.spanish },
    { path: TEST_DATA.translationWords.faith.path, format: TEST_DATA.formats.json },
    { path: TEST_DATA.translationWords.faith.path, format: TEST_DATA.formats.markdown },
    { path: TEST_DATA.translationWords.faith.path, category: TEST_DATA.translationWords.faith.category },
    { path: TEST_DATA.translationWords.faith.path, organization: TEST_DATA.organizations.unfoldingWord },
    { path: TEST_DATA.translationWords.faith.path, organization: TEST_DATA.organizations.all },
  ],

  translationAcademy: [
    { path: TEST_DATA.translationAcademy.metaphor.path },
    { path: TEST_DATA.translationAcademy.metaphor.path, language: TEST_DATA.languages.english },
    { path: TEST_DATA.translationAcademy.metaphor.path, language: TEST_DATA.languages.spanish },
    { path: TEST_DATA.translationAcademy.metaphor.path, language: TEST_DATA.languages.spanishVariant },
    { path: TEST_DATA.translationAcademy.metaphor.path, format: TEST_DATA.formats.json },
    { path: TEST_DATA.translationAcademy.metaphor.path, format: TEST_DATA.formats.markdown },
    { path: TEST_DATA.translationAcademy.metaphor.path, topic: TEST_DATA.topics.default },
    { path: TEST_DATA.translationAcademy.metaphor.path, organization: TEST_DATA.organizations.unfoldingWord },
    { path: TEST_DATA.translationAcademy.metaphor.path, organization: TEST_DATA.organizations.all },
  ],
  ...
  listResourcesForLanguage: [
    ...
    { language: TEST_DATA.languages.english, organization: TEST_DATA.organizations.unfoldingWord },
    { language: TEST_DATA.languages.spanish, organization: TEST_DATA.organizations.all },
  ],
};
...
export const EXPECTED_STRUCTURES = {
  scripture: {
    requiredFields: ['text', 'reference'],
    optionalFields: ['language', 'version', 'metadata']
  },

  translationNotes: {
    requiredFields: ['notes', 'reference'],
...
export const TOOL_ENDPOINT_MAP = {
  ...
  'test_mockup_tool': 'test-mockup-tool',
};
...
export const PROMPT_METADATA = {
  'translation-helps-report': {
    ...
    expectedTools: ['fetch_scripture', 'fetch_translation_notes', 'fetch_translation_word_links']
  },
  'translation-helps-for-passage': {
    description: 'Comprehensive report for a passage',
    requiredArgs: ['reference'],
    optionalArgs: ['language'],
    expectedTools: ['fetch_scripture', 'fetch_translation_notes', 'fetch_translation_questions', 'fetch_translation_word_links', 'fetch_translation_academy']
  },
