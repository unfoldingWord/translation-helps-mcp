...
describe('/api/fetch-translation-questions', () => {
	describe('Basic Functionality', () => {
		it('should return translation questions for a valid reference', async () => {
			const response = await makeRequest('/api/fetch-translation-questions', {
				reference: 'John 3:16',
				language: 'en',
	...
	describe('CORS Support', () => {
		...
		it('should handle OPTIONS request for CORS preflight', async () => {
			const response = await fetch('http://localhost:8174/api/fetch-translation-questions', {
				method: 'OPTIONS'
			});
