 ...
 * Unified Translation Questions Service
 */
export class TranslationQuestionsService extends BaseService<
  TranslationQuestionsParams,
  TranslationQuestionsResult
> {
...
export function createTranslationQuestionsService(
  _context?: ServiceContext,
): TranslationQuestionsService {
