...
export const TOOL_DOC_META: Record<string, ToolDocMeta> = {
  ...
  get_obs_story: {
    ...
    example: { reference: "3:1-3", language: "spa" },
    exampleResponse: {
      reference: "3:1-3",
      language: "es-419",
      story: 3,
      ...
      frames: [
        ...
        { index: 3, imageUrl: null, text: "So God decided to send…" },
      ],
      ...
      notes: [
        {
          ...
          reference: "3:1",
          quote: "wicked",
          note: "This means very evil…",
        },
        {
          id: "obs-n2",
          reference: "3:2",
          quote: "flood",
          note: "A flood is when water covers the land…",
        },
      ],
    },
    responseNotes: [
      "Range and whole-story references return notes for all matching frames in one `notes` array.",
      "`language` may differ from the requested code after variant resolution (e.g. spa → es → es-419).",
      ...
      questions: [
        {
          ...
          response: "Because the people were very wicked.",
        },
        {
          id: "obs-q2",
          reference: "3:2",
          question: "Who found favor with God?",
          response: "Noah",
        },
      ],
    },
    responseNotes: [
      "Range and whole-story references return questions for all matching frames in one `questions` array.",
      "`language` may differ from the requested code after variant resolution (e.g. spa → es → es-419).",
