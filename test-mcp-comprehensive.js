...
async function testComprehensive() {
  ...
  try {
    ...
    if (
      ...
      console.log(
        `   ✅ Success! Found ${data.result.prompts.length} prompts\n`,
      );
    } else {
      console.log(
        "   ❌ Failed:",
  ...
  try {
    ...
    if (
      ...
      console.log(
        `   ✅ Success! Got prompt with ${data.result.messages.length} messages\n`,
      );
    } else {
      console.log(
        "   ❌ Failed:",
  ...
  try {
    ...
    if (response.status === 200 && data.prompts) {
      console.log(
        `   ✅ Success! Found ${data.prompts.length} prompts via GET\n`,
      );
    } else {
      console.log(
        "   ❌ Failed:",
